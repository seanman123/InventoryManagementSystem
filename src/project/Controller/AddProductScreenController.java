...
public class AddProductScreenController implements Initializable {
    ...
    public void saveButtonHandler(ActionEvent actionEvent) throws IOException {
        ...
        try {
            ...
            if (errorMessage.length() > 0) {
                ...
                Product product = new Product(partID, part, Double.parseDouble(price), Integer.parseInt(inv), Integer.parseInt(min), Integer.parseInt(max));
    ...
    public void exitButtonHandler(ActionEvent actionEvent) throws IOException {
        ...
        Inventory.decrementProductIDNumber();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        partID = Inventory.getProductIDNumber();
